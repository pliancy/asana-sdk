...
export const TasksApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        deleteTask: async (taskGid: string, optPretty?: boolean, optFields?: Array<string>, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'taskGid' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        getDependenciesForTask: async (taskGid: string, optPretty?: boolean, optFields?: Array<string>, limit?: number, offset?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'taskGid' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        getDependentsForTask: async (taskGid: string, optPretty?: boolean, optFields?: Array<string>, limit?: number, offset?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'taskGid' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        getSubtasksForTask: async (taskGid: string, optPretty?: boolean, optFields?: Array<string>, limit?: number, offset?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'taskGid' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        getTask: async (taskGid: string, optPretty?: boolean, optFields?: Array<string>, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'taskGid' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        getTasks: async (optPretty?: boolean, optFields?: Array<string>, limit?: number, offset?: string, assignee?: string, project?: string, section?: string, workspace?: string, completedSince?: string, modifiedSince?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/tasks`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
         ...
         * @throws {RequiredError}
         */
        getTasksForSection: async (sectionGid: string, optPretty?: boolean, optFields?: Array<string>, limit?: number, offset?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        getTasksForTag: async (tagGid: string, optPretty?: boolean, optFields?: Array<string>, limit?: number, offset?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        getTasksForUserTaskList: async (userTaskListGid: string, completedSince?: string, optPretty?: boolean, optFields?: Array<string>, limit?: number, offset?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @param {string} [followersAny] Comma-separated list of user identifiers
         ...
         * @param {string} [likedByAny] Comma-separated list of user identifiers
         * @param {string} [likedByNot] Comma-separated list of user identifiers
         * @param {string} [commentedOnByAny] Comma-separated list of user identifiers
        ...
        searchTasksForWorkspace: async (workspaceGid: string, optPretty?: boolean, optFields?: Array<string>, text?: string, resourceSubtype?: 'default_task' | 'milestone', assigneeAny?: string, assigneeNot?: string, portfoliosAny?: string, projectsAny?: string, projectsNot?: string, projectsAll?: string, sectionsAny?: string, sectionsNot?: string, sectionsAll?: string, tagsAny?: string, tagsNot?: string, tagsAll?: string, teamsAny?: string, followersAny?: string, followersNot?: string, createdByAny?: string, createdByNot?: string, assignedByAny?: string, assignedByNot?: string, likedByAny?: string, likedByNot?: string, commentedOnByAny?: string, commentedOnByNot?: string, dueOnBefore?: string, dueOnAfter?: string, dueOn?: string, dueAtBefore?: string, dueAtAfter?: string, startOnBefore?: string, startOnAfter?: string, startOn?: string, createdOnBefore?: string, createdOnAfter?: string, createdOn?: string, createdAtBefore?: string, createdAtAfter?: string, completedOnBefore?: string, completedOnAfter?: string, completedOn?: string, completedAtBefore?: string, completedAtAfter?: string, modifiedOnBefore?: string, modifiedOnAfter?: string, modifiedOn?: string, modifiedAtBefore?: string, modifiedAtAfter?: string, isBlocking?: boolean, isBlocked?: boolean, hasAttachment?: boolean, completed?: boolean, isSubtask?: boolean, sortBy?: 'due_date' | 'created_at' | 'completed_at' | 'likes' | 'modified_at', sortAscending?: boolean, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            if (likedByAny !== undefined) {
                localVarQueryParameter['liked_by.any'] = likedByAny;
            }
            ...
            if (commentedOnByAny !== undefined) {
                localVarQueryParameter['commented_on_by.any'] = commentedOnByAny;
            }
...
export const TasksApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async deleteTask(taskGid: string, optPretty?: boolean, optFields?: Array<string>, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse2001>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.deleteTask(taskGid, optPretty, optFields, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Creates and returns a job that will asynchronously handle the duplication.
         ...
         * @throws {RequiredError}
         */
        async getTask(taskGid: string, optPretty?: boolean, optFields?: Array<string>, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse2016>> {
...
export const TasksApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        deleteTask(taskGid: string, optPretty?: boolean, optFields?: Array<string>, options?: any): AxiosPromise<InlineResponse2001> {
            return localVarFp.deleteTask(taskGid, optPretty, optFields, options).then((request) => request(axios, basePath));
        },
        /**
         * Creates and returns a job that will asynchronously handle the duplication.
         * @summary Duplicate a task
         ...
         * @throws {RequiredError}
         */
        getTask(taskGid: string, optPretty?: boolean, optFields?: Array<string>, options?: any): AxiosPromise<InlineResponse2016> {
        ...
        searchTasksForWorkspace(workspaceGid: string, optPretty?: boolean, optFields?: Array<string>, text?: string, resourceSubtype?: 'default_task' | 'milestone', assigneeAny?: string, assigneeNot?: string, portfoliosAny?: string, projectsAny?: string, projectsNot?: string, projectsAll?: string, sectionsAny?: string, sectionsNot?: string, sectionsAll?: string, tagsAny?: string, tagsNot?: string, tagsAll?: string, teamsAny?: string, followersAny?: string, followersNot?: string, createdByAny?: string, createdByNot?: string, assignedByAny?: string, assignedByNot?: string, likedByAny?: string, likedByNot?: string, commentedOnByAny?: string, commentedOnByNot?: string, dueOnBefore?: string, dueOnAfter?: string, dueOn?: string, dueAtBefore?: string, dueAtAfter?: string, startOnBefore?: string, startOnAfter?: string, startOn?: string, createdOnBefore?: string, createdOnAfter?: string, createdOn?: string, createdAtBefore?: string, createdAtAfter?: string, completedOnBefore?: string, completedOnAfter?: string, completedOn?: string, completedAtBefore?: string, completedAtAfter?: string, modifiedOnBefore?: string, modifiedOnAfter?: string, modifiedOn?: string, modifiedAtBefore?: string, modifiedAtAfter?: string, isBlocking?: boolean, isBlocked?: boolean, hasAttachment?: boolean, completed?: boolean, isSubtask?: boolean, sortBy?: 'due_date' | 'created_at' | 'completed_at' | 'likes' | 'modified_at', sortAscending?: boolean, options?: any): AxiosPromise<InlineResponse20026> {
            return localVarFp.searchTasksForWorkspace(workspaceGid, optPretty, optFields, text, resourceSubtype, assigneeAny, assigneeNot, portfoliosAny, projectsAny, projectsNot, projectsAll, sectionsAny, sectionsNot, sectionsAll, tagsAny, tagsNot, tagsAll, teamsAny, followersAny, followersNot, createdByAny, createdByNot, assignedByAny, assignedByNot, likedByAny, likedByNot, commentedOnByAny, commentedOnByNot, dueOnBefore, dueOnAfter, dueOn, dueAtBefore, dueAtAfter, startOnBefore, startOnAfter, startOn, createdOnBefore, createdOnAfter, createdOn, createdAtBefore, createdAtAfter, completedOnBefore, completedOnAfter, completedOn, completedAtBefore, completedAtAfter, modifiedOnBefore, modifiedOnAfter, modifiedOn, modifiedAtBefore, modifiedAtAfter, isBlocking, isBlocked, hasAttachment, completed, isSubtask, sortBy, sortAscending, options).then((request) => request(axios, basePath));
        },
        /**
         * parent, or no parent task at all. Returns an empty data block. When using `insert_before` and `insert_after`, at most one of those two options can be specified, and they must already be subtasks of the parent.
         * @summary Set the parent of a task
...
export class TasksApi extends BaseAPI {
     ...
     * @memberof TasksApi
     */
    public deleteTask(taskGid: string, optPretty?: boolean, optFields?: Array<string>, options?: AxiosRequestConfig) {
        return TasksApiFp(this.configuration).deleteTask(taskGid, optPretty, optFields, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof TasksApi
     */
    public getDependenciesForTask(taskGid: string, optPretty?: boolean, optFields?: Array<string>, limit?: number, offset?: string, options?: AxiosRequestConfig) {
        return TasksApiFp(this.configuration).getDependenciesForTask(taskGid, optPretty, optFields, limit, offset, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof TasksApi
     */
    public getDependentsForTask(taskGid: string, optPretty?: boolean, optFields?: Array<string>, limit?: number, offset?: string, options?: AxiosRequestConfig) {
        return TasksApiFp(this.configuration).getDependentsForTask(taskGid, optPretty, optFields, limit, offset, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof TasksApi
     */
    public getSubtasksForTask(taskGid: string, optPretty?: boolean, optFields?: Array<string>, limit?: number, offset?: string, options?: AxiosRequestConfig) {
        return TasksApiFp(this.configuration).getSubtasksForTask(taskGid, optPretty, optFields, limit, offset, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof TasksApi
     */
    public getTask(taskGid: string, optPretty?: boolean, optFields?: Array<string>, options?: AxiosRequestConfig) {
     ...
     * @memberof TasksApi
     */
    public getTasks(optPretty?: boolean, optFields?: Array<string>, limit?: number, offset?: string, assignee?: string, project?: string, section?: string, workspace?: string, completedSince?: string, modifiedSince?: string, options?: AxiosRequestConfig) {
        return TasksApiFp(this.configuration).getTasks(optPretty, optFields, limit, offset, assignee, project, section, workspace, completedSince, modifiedSince, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof TasksApi
     */
    public getTasksForSection(sectionGid: string, optPretty?: boolean, optFields?: Array<string>, limit?: number, offset?: string, options?: AxiosRequestConfig) {
        return TasksApiFp(this.configuration).getTasksForSection(sectionGid, optPretty, optFields, limit, offset, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof TasksApi
     */
    public getTasksForTag(tagGid: string, optPretty?: boolean, optFields?: Array<string>, limit?: number, offset?: string, options?: AxiosRequestConfig) {
        return TasksApiFp(this.configuration).getTasksForTag(tagGid, optPretty, optFields, limit, offset, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof TasksApi
     */
    public getTasksForUserTaskList(userTaskListGid: string, completedSince?: string, optPretty?: boolean, optFields?: Array<string>, limit?: number, offset?: string, options?: AxiosRequestConfig) {
        return TasksApiFp(this.configuration).getTasksForUserTaskList(userTaskListGid, completedSince, optPretty, optFields, limit, offset, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof TasksApi
     */
    public searchTasksForWorkspace(workspaceGid: string, optPretty?: boolean, optFields?: Array<string>, text?: string, resourceSubtype?: 'default_task' | 'milestone', assigneeAny?: string, assigneeNot?: string, portfoliosAny?: string, projectsAny?: string, projectsNot?: string, projectsAll?: string, sectionsAny?: string, sectionsNot?: string, sectionsAll?: string, tagsAny?: string, tagsNot?: string, tagsAll?: string, teamsAny?: string, followersAny?: string, followersNot?: string, createdByAny?: string, createdByNot?: string, assignedByAny?: string, assignedByNot?: string, likedByAny?: string, likedByNot?: string, commentedOnByAny?: string, commentedOnByNot?: string, dueOnBefore?: string, dueOnAfter?: string, dueOn?: string, dueAtBefore?: string, dueAtAfter?: string, startOnBefore?: string, startOnAfter?: string, startOn?: string, createdOnBefore?: string, createdOnAfter?: string, createdOn?: string, createdAtBefore?: string, createdAtAfter?: string, completedOnBefore?: string, completedOnAfter?: string, completedOn?: string, completedAtBefore?: string, completedAtAfter?: string, modifiedOnBefore?: string, modifiedOnAfter?: string, modifiedOn?: string, modifiedAtBefore?: string, modifiedAtAfter?: string, isBlocking?: boolean, isBlocked?: boolean, hasAttachment?: boolean, completed?: boolean, isSubtask?: boolean, sortBy?: 'due_date' | 'created_at' | 'completed_at' | 'likes' | 'modified_at', sortAscending?: boolean, options?: AxiosRequestConfig) {
        return TasksApiFp(this.configuration).searchTasksForWorkspace(workspaceGid, optPretty, optFields, text, resourceSubtype, assigneeAny, assigneeNot, portfoliosAny, projectsAny, projectsNot, projectsAll, sectionsAny, sectionsNot, sectionsAll, tagsAny, tagsNot, tagsAll, teamsAny, followersAny, followersNot, createdByAny, createdByNot, assignedByAny, assignedByNot, likedByAny, likedByNot, commentedOnByAny, commentedOnByNot, dueOnBefore, dueOnAfter, dueOn, dueAtBefore, dueAtAfter, startOnBefore, startOnAfter, startOn, createdOnBefore, createdOnAfter, createdOn, createdAtBefore, createdAtAfter, completedOnBefore, completedOnAfter, completedOn, completedAtBefore, completedAtAfter, modifiedOnBefore, modifiedOnAfter, modifiedOn, modifiedAtBefore, modifiedAtAfter, isBlocking, isBlocked, hasAttachment, completed, isSubtask, sortBy, sortAscending, options).then((request) => request(this.axios, this.basePath));
    }
