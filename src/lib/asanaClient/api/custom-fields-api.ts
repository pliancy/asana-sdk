...
export const CustomFieldsApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        createCustomField: async (inlineObject1: InlineObject1, optPretty?: boolean, optFields?: Array<'asana_created_field' | 'created_by' | 'created_by.name' | 'currency_code' | 'custom_label' | 'custom_label_position' | 'date_value' | 'date_value.date' | 'date_value.date_time' | 'description' | 'display_value' | 'enabled' | 'enum_options' | 'enum_options.color' | 'enum_options.enabled' | 'enum_options.name' | 'enum_value' | 'enum_value.color' | 'enum_value.enabled' | 'enum_value.name' | 'format' | 'has_notifications_enabled' | 'id_prefix' | 'is_formula_field' | 'is_global_to_workspace' | 'is_value_read_only' | 'multi_enum_values' | 'multi_enum_values.color' | 'multi_enum_values.enabled' | 'multi_enum_values.name' | 'name' | 'number_value' | 'people_value' | 'people_value.name' | 'precision' | 'representation_type' | 'resource_subtype' | 'text_value' | 'type'>, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'inlineObject1' is not null or undefined
            assertParamExists('createCustomField', 'inlineObject1', inlineObject1)
         ...
         * @throws {RequiredError}
         */
        updateCustomField: async (customFieldGid: string, optPretty?: boolean, optFields?: Array<'asana_created_field' | 'created_by' | 'created_by.name' | 'currency_code' | 'custom_label' | 'custom_label_position' | 'date_value' | 'date_value.date' | 'date_value.date_time' | 'description' | 'display_value' | 'enabled' | 'enum_options' | 'enum_options.color' | 'enum_options.enabled' | 'enum_options.name' | 'enum_value' | 'enum_value.color' | 'enum_value.enabled' | 'enum_value.name' | 'format' | 'has_notifications_enabled' | 'id_prefix' | 'is_formula_field' | 'is_global_to_workspace' | 'is_value_read_only' | 'multi_enum_values' | 'multi_enum_values.color' | 'multi_enum_values.enabled' | 'multi_enum_values.name' | 'name' | 'number_value' | 'people_value' | 'people_value.name' | 'precision' | 'representation_type' | 'resource_subtype' | 'text_value' | 'type'>, inlineObject2?: InlineObject2, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'customFieldGid' is not null or undefined
...
export const CustomFieldsApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async createCustomField(inlineObject1: InlineObject1, optPretty?: boolean, optFields?: Array<'asana_created_field' | 'created_by' | 'created_by.name' | 'currency_code' | 'custom_label' | 'custom_label_position' | 'date_value' | 'date_value.date' | 'date_value.date_time' | 'description' | 'display_value' | 'enabled' | 'enum_options' | 'enum_options.color' | 'enum_options.enabled' | 'enum_options.name' | 'enum_value' | 'enum_value.color' | 'enum_value.enabled' | 'enum_value.name' | 'format' | 'has_notifications_enabled' | 'id_prefix' | 'is_formula_field' | 'is_global_to_workspace' | 'is_value_read_only' | 'multi_enum_values' | 'multi_enum_values.color' | 'multi_enum_values.enabled' | 'multi_enum_values.name' | 'name' | 'number_value' | 'people_value' | 'people_value.name' | 'precision' | 'representation_type' | 'resource_subtype' | 'text_value' | 'type'>, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse201>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.createCustomField(inlineObject1, optPretty, optFields, options);
         ...
         * @throws {RequiredError}
         */
        async updateCustomField(customFieldGid: string, optPretty?: boolean, optFields?: Array<'asana_created_field' | 'created_by' | 'created_by.name' | 'currency_code' | 'custom_label' | 'custom_label_position' | 'date_value' | 'date_value.date' | 'date_value.date_time' | 'description' | 'display_value' | 'enabled' | 'enum_options' | 'enum_options.color' | 'enum_options.enabled' | 'enum_options.name' | 'enum_value' | 'enum_value.color' | 'enum_value.enabled' | 'enum_value.name' | 'format' | 'has_notifications_enabled' | 'id_prefix' | 'is_formula_field' | 'is_global_to_workspace' | 'is_value_read_only' | 'multi_enum_values' | 'multi_enum_values.color' | 'multi_enum_values.enabled' | 'multi_enum_values.name' | 'name' | 'number_value' | 'people_value' | 'people_value.name' | 'precision' | 'representation_type' | 'resource_subtype' | 'text_value' | 'type'>, inlineObject2?: InlineObject2, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse201>> {
...
export const CustomFieldsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        createCustomField(inlineObject1: InlineObject1, optPretty?: boolean, optFields?: Array<'asana_created_field' | 'created_by' | 'created_by.name' | 'currency_code' | 'custom_label' | 'custom_label_position' | 'date_value' | 'date_value.date' | 'date_value.date_time' | 'description' | 'display_value' | 'enabled' | 'enum_options' | 'enum_options.color' | 'enum_options.enabled' | 'enum_options.name' | 'enum_value' | 'enum_value.color' | 'enum_value.enabled' | 'enum_value.name' | 'format' | 'has_notifications_enabled' | 'id_prefix' | 'is_formula_field' | 'is_global_to_workspace' | 'is_value_read_only' | 'multi_enum_values' | 'multi_enum_values.color' | 'multi_enum_values.enabled' | 'multi_enum_values.name' | 'name' | 'number_value' | 'people_value' | 'people_value.name' | 'precision' | 'representation_type' | 'resource_subtype' | 'text_value' | 'type'>, options?: any): AxiosPromise<InlineResponse201> {
            return localVarFp.createCustomField(inlineObject1, optPretty, optFields, options).then((request) => request(axios, basePath));
        },
        /**
         * Creates an enum option and adds it to this custom field’s list of enum options. A custom field can have at most 500 enum options (including disabled options). By default new enum options are inserted at the end of a custom field’s list. Locked custom fields can only have enum options added by the user who locked the field. Returns the full record of the newly created enum option.
         * @summary Create an enum option
...
export class CustomFieldsApi extends BaseAPI {
     ...
     */
    public createCustomField(inlineObject1: InlineObject1, optPretty?: boolean, optFields?: Array<'asana_created_field' | 'created_by' | 'created_by.name' | 'currency_code' | 'custom_label' | 'custom_label_position' | 'date_value' | 'date_value.date' | 'date_value.date_time' | 'description' | 'display_value' | 'enabled' | 'enum_options' | 'enum_options.color' | 'enum_options.enabled' | 'enum_options.name' | 'enum_value' | 'enum_value.color' | 'enum_value.enabled' | 'enum_value.name' | 'format' | 'has_notifications_enabled' | 'id_prefix' | 'is_formula_field' | 'is_global_to_workspace' | 'is_value_read_only' | 'multi_enum_values' | 'multi_enum_values.color' | 'multi_enum_values.enabled' | 'multi_enum_values.name' | 'name' | 'number_value' | 'people_value' | 'people_value.name' | 'precision' | 'representation_type' | 'resource_subtype' | 'text_value' | 'type'>, options?: AxiosRequestConfig) {
        return CustomFieldsApiFp(this.configuration).createCustomField(inlineObject1, optPretty, optFields, options).then((request) => request(this.axios, this.basePath));
    }
