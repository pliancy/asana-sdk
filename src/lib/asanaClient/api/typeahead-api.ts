...
export const TypeaheadApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        typeaheadForWorkspace(workspaceGid: string, resourceType: 'custom_field' | 'project' | 'project_template' | 'portfolio' | 'tag' | 'task' | 'user', type?: 'custom_field' | 'portfolio' | 'project' | 'tag' | 'task' | 'user', query?: string, count?: number, optPretty?: boolean, optFields?: Array<'name'>, options?: any): AxiosPromise<InlineResponse20047> {
