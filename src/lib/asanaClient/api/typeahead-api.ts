...
export const TypeaheadApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        typeaheadForWorkspace: async (workspaceGid: string, resourceType: 'custom_field' | 'goal' | 'project' | 'project_template' | 'portfolio' | 'tag' | 'task' | 'team' | 'user', type?: 'custom_field' | 'portfolio' | 'project' | 'tag' | 'task' | 'user', query?: string, count?: number, optPretty?: boolean, optFields?: Array<'name'>, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const TypeaheadApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async typeaheadForWorkspace(workspaceGid: string, resourceType: 'custom_field' | 'goal' | 'project' | 'project_template' | 'portfolio' | 'tag' | 'task' | 'team' | 'user', type?: 'custom_field' | 'portfolio' | 'project' | 'tag' | 'task' | 'user', query?: string, count?: number, optPretty?: boolean, optFields?: Array<'name'>, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse20047>> {
...
export const TypeaheadApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        typeaheadForWorkspace(workspaceGid: string, resourceType: 'custom_field' | 'goal' | 'project' | 'project_template' | 'portfolio' | 'tag' | 'task' | 'team' | 'user', type?: 'custom_field' | 'portfolio' | 'project' | 'tag' | 'task' | 'user', query?: string, count?: number, optPretty?: boolean, optFields?: Array<'name'>, options?: any): AxiosPromise<InlineResponse20047> {
...
export class TypeaheadApi extends BaseAPI {
     ...
     */
    public typeaheadForWorkspace(workspaceGid: string, resourceType: 'custom_field' | 'goal' | 'project' | 'project_template' | 'portfolio' | 'tag' | 'task' | 'team' | 'user', type?: 'custom_field' | 'portfolio' | 'project' | 'tag' | 'task' | 'user', query?: string, count?: number, optPretty?: boolean, optFields?: Array<'name'>, options?: AxiosRequestConfig) {
