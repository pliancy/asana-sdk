...
export const TypeaheadApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {'custom_field' | 'portfolio' | 'project' | 'tag' | 'task' | 'user'} resourceType The type of values the typeahead should return. You can choose from one of the following: &#x60;custom_field&#x60;, &#x60;project&#x60;, &#x60;portfolio&#x60;, &#x60;tag&#x60;, &#x60;task&#x60;, and &#x60;user&#x60;. Note that unlike in the names of endpoints, the types listed here are in singular form (e.g. &#x60;task&#x60;). Using multiple types is not yet supported.
         ...
         * @param {string} [query] The string that will be used to search for relevant objects. If an empty string is passed in, the API will currently return an empty result set.
         ...
         */
        typeaheadForWorkspace: async (workspaceGid: string, resourceType: 'custom_field' | 'portfolio' | 'project' | 'tag' | 'task' | 'user', type?: 'custom_field' | 'portfolio' | 'project' | 'tag' | 'task' | 'user', query?: string, count?: number, optPretty?: boolean, optFields?: Array<string>, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const TypeaheadApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async typeaheadForWorkspace(workspaceGid: string, resourceType: 'custom_field' | 'portfolio' | 'project' | 'tag' | 'task' | 'user', type?: 'custom_field' | 'portfolio' | 'project' | 'tag' | 'task' | 'user', query?: string, count?: number, optPretty?: boolean, optFields?: Array<string>, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InlineResponse20033>> {
...
export const TypeaheadApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        typeaheadForWorkspace(workspaceGid: string, resourceType: 'custom_field' | 'portfolio' | 'project' | 'tag' | 'task' | 'user', type?: 'custom_field' | 'portfolio' | 'project' | 'tag' | 'task' | 'user', query?: string, count?: number, optPretty?: boolean, optFields?: Array<string>, options?: any): AxiosPromise<InlineResponse20033> {
...
export class TypeaheadApi extends BaseAPI {
     ...
     */
    public typeaheadForWorkspace(workspaceGid: string, resourceType: 'custom_field' | 'portfolio' | 'project' | 'tag' | 'task' | 'user', type?: 'custom_field' | 'portfolio' | 'project' | 'tag' | 'task' | 'user', query?: string, count?: number, optPretty?: boolean, optFields?: Array<string>, options?: AxiosRequestConfig) {
